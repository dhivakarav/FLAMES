...
;
const metadata = {
    title: "FLAMES Calculator - Discover Your Relationship Destiny",
    description: "Calculate your relationship compatibility with the classic FLAMES game. Friends, Love, Affection, Marriage, Enemy, or Sister?",
    generator: "v0.app",
    icons: {
        icon: [
            {
